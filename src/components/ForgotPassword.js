...
const ForgotPassword = () => {
    ...
    const userValid = async () => {
        const res = await fetch(`https://url-shortener-laf1.onrender.com/forgotpassword/${id}/${token}`, {
            method: "GET",
            headers: {
    ...
    const sendpassword = async (e) => {
        ...
        if (password === "") {
            ...
            const res = await fetch(`https://url-shortener-laf1.onrender.com/${id}/${token}`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
